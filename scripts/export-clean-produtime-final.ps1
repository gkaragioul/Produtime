...
$destFolder = Join-Path $desktop 'ProduTime-1.6.8-Clean'
...
Write-Host ""
Write-Host "SUCCESS! Clean ProduTime 1.6.8 exported to Desktop" -ForegroundColor Green
Write-Host "Folder: $destFolder" -ForegroundColor Cyan
Write-Host "Executable: ProduTime.exe" -ForegroundColor Cyan
Write-Host "Shortcut: ProduTime-1.6.8-Clean.lnk" -ForegroundColor Cyan
Write-Host ""
