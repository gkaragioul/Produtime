          ...
          <div className="settings-content">
            ...
            <div className="settings-section">
              ...
              <div className="form-group">
                ...
                >
                  <button
                    ...
                    disabled={isLoading || checkingForUpdates}
                  >
                    {checkingForUpdates ? 'Checking...' : 'Check Now'}
                  </button>
                  <button
                    className="btn btn-secondary"
                    onClick={handleOpenUpdateLogs}
                    disabled={isLoading}
                ...
                <div className="field-help">
                  Manually check for application updates. Updates are also
                  checked automatically every 24 hours.
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                >
                  {autoUpdaterService.formatLastCheckTime(lastCheckTime)}
                </div>
                <div className="field-help">
                  The application automatically checks for updates on startup
                  and every 24 hours. You'll be notified when a new version is available (daily check).
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <li>✅ Desktop notifications when updates are available</li>
                  <li>✅ One-click download and install</li>
                  <li>✅ Seamless portable update process</li>
                  <li>✅ Detailed update logs for troubleshooting</li>
                  <li>✅ Network retry logic with timeout handling</li>
                </ul>
              </div>
            </div>

            {/* License Management Section */}
            {/* License Management Section - removed */}
            {/* Moved to Help > Enter License Key… */}
