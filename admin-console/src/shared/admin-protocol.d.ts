 ...
 */
export type AdminMessageType = 'HEARTBEAT' | 'STATS_SUMMARY' | 'PAIR_REQUEST' | 'PAIR_APPROVED' | 'PAIR_DENIED' | 'IDENTIFY' | 'POLICY_PUSH' | 'EXPORT_REQUEST' | 'EXPORT_RESULT' | 'STATS_SNAPSHOT_REQUEST' | 'STATS_SNAPSHOT_RESULT' | 'LOCK' | 'UNLOCK' | 'UNPAIR' | 'ERROR' | 'ACK';
